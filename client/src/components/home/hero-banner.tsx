        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
          ...
          >
            ...
            <div className="flex items-center justify-center md:justify-start space-x-4 pt-2">
              ...
              <Link href="/products?tag=summer" className="text-sm text-gray-700 hover:text-primary-600">#SummerCollection</Link>
              <Link href="/products?tag=festive" className="text-sm text-gray-700 hover:text-primary-600">#FestiveLook</Link>
            </div>
          </motion.div>
          ...
          <div className="relative">
            <AnimatePresence mode="wait">
              ...
              >
                ...
                <div className="absolute bottom-0 left-0 right-0 p-6 bg-gradient-to-t from-black/60 to-transparent">
                  <span className="inline-block px-4 py-1 bg-primary-600 text-white text-xs font-bold rounded-full">
                    {current.tag}
                  </span>
                  <h3 className="mt-2 text-xl font-bold text-white">{current.collection}</h3>
                </div>
              </motion.div>
            </AnimatePresence>
            ...
            >
              <span className="font-accent text-lg font-bold text-primary-600">{current.discount}</span>
            </motion.div>
